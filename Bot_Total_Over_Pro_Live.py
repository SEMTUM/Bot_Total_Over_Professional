...
MIN_AVG_PROBABILITY = 0.80      # Минимальная средняя вероятность
MIN_BOOKMAKER_ODDS = 1.10       # Минимальный коэффициент букмекера
MAX_BOOKMAKER_ODDS = 1.70       # Максимальный коэффициент букмекера
