...
# ==============================================
# КОНФИГУРАЦИЯ BOT TOTAL OVER PRO
# ==============================================
...
MAX_BOOKMAKER_ODDS = 8.00       # Максимальный коэффициент букмекера
...
ENABLED_METHODS = {
    ...
    'bayesian': (False, 10),             # 🥇 Обязательно Байесовский подход Адаптивный - обновляет вероятности
    'historical_totals': (False, 10),    # 🥈 Рекомендуется Исторические тоталы Хороший базовый индикатор тоталов
    'recent_form': (False, 5),           # 🥈 Рекомендуется Форма последних матчей Важен для текущей формы команд
    'ml_approach': (False, 10)           # 🥈 Рекомендуется ML подход Упрощенный ML дает неплохие результаты
}

# ТЕЛЕГРАМ ТОКЕН И АДМИНИСТРАТОР
TEL_TOKEN = "8223165829:AAHzLLJyq-FINGhfamCWA1h0dy1oBBi2M4E"  # Токен бота
